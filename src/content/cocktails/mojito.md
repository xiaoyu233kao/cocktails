...
ingredients:
  - nameZh: 古巴白朗姆
    nameEn: White Cuban Ron
    amount: 45 ml
    aliases: [white rum, Cuban rum, 白朗姆]
  - nameZh: 鲜青柠汁
  ...
  - nameZh: 薄荷枝
    nameEn: Mint Sprigs
    amount: 6 pcs
    aliases: [mint, fresh mint, 薄荷]
  - nameZh: 白蔗糖
    nameEn: White Cane Sugar
    amount: 2 tsp
    aliases: [cane sugar, sugar, 蔗糖]
  - nameZh: 苏打水
    nameEn: Soda Water
    amount: to top
...
story:
  text: 莫希托常被追溯到 16 世纪的 el Draque：青柠、糖与粗制甘蔗酒先行组合，19 世纪末朗姆酒取代了原来的 aguardiente；海明威后来进一步提升了它的知名度。
  source:
    label: Smithsonian Institution — Mojito History
    url: https://americanhistory.si.edu/sites/default/files/file-uploader/Cook%20History-September%2017-Mojito.pdf
    checkedAt: 2026-09-18
variants:
  - name: Queen's Park Swizzle
    description: 以德梅拉拉朗姆、青柠、糖浆和薄荷构成的特立尼达 Swizzle，常被视为莫希托的非 IBA 近亲。
    source:
      label: VinePair — The Queen's Park Swizzle
      url: https://vinepair.com/cocktail-recipe/the-queens-park-swizzle/
      checkedAt: 2026-09-18
---
