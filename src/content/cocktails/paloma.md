...
category: New Era
baseSpirit: tequila
flavors: [grapefruit, citrus, salty]
styles: [built, highball]
ingredients:
  - nameZh: 100% 龙舌兰酒
    nameEn: 100% Agave Tequila
    amount: 50 ml
    aliases: [tequila, agave tequila, 龙舌兰]
  - nameZh: 鲜青柠汁
...
story:
  text: 帕洛玛的早期流传与墨西哥特基拉帕克相连，20 世纪末才更常以 Paloma 之名出现；资料也记录了用葡萄柚汽水调制和用新鲜葡萄柚、糖浆、苏打水重做的两条传统。
  source:
    label: Oxford Companion to Spirits & Cocktails — Paloma
    url: https://www.spiritsanddistilling.com/dictionary/acref-9780199311132-e-379
    checkedAt: 2026-09-18
variants:
  - name: Cantarito
    description: 在陶土杯中把龙舌兰与葡萄柚、橙、柠檬等多种柑橘和汽水混合，是帕洛玛的非 IBA 墨西哥近亲。
    source:
      label: Mexican Spirits Bible — Cantarito
      url: https://mexicanspiritsbible.com/en/cocktails/cantarito
      checkedAt: 2026-09-18
---
