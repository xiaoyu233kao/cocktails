...
category: New Era
baseSpirit: tequila
flavors: [citrus, sweet, agave, refreshing]
styles: [shaken, rocks, sour]
ingredients:
  - nameZh: 100% 龙舌兰酒
    nameEn: Tequila 100% Agave
    amount: 60 ml
    aliases: [tequila, 100% agave tequila, 龙舌兰]
  - nameZh: 鲜青柠汁
...
historySources:
  - label: IBA Tommy's Margarita
    url: https://iba-world.com/iba-cocktail/tommys-margarita/
    checkedAt: 2026-09-19
  - label: Liquor.com — Tommy's Margarita
    url: https://www.liquor.com/recipes/tommys-margarita/
    checkedAt: 2026-09-19
steps:
  - 将所有原料加入摇酒器，加冰充分摇匀。
  - 滤入装有冰块的冰镇古典杯。
...
garnish: 青柠片
image: /images/cocktails/tommys-margarita.webp
imageAlt: 以青柠片装饰的加冰汤米玛格丽塔
imageCredit:
  kind: generated
...
variants:
  - name: Margarita
    description: 经典玛格丽塔以龙舌兰、橙味利口酒和青柠汁摇制，通常配盐口；汤米版本以龙舌兰糖浆取代橙味利口酒。
    source:
      label: IBA Margarita
